...
(function(exports){
    function Nick(){
        ...
        this.prevObj = {};
        this.Cheack = "";
        $.getScript("asset/animate/character/nick/ani_nick.js",$.proxy(function(data, textStatus, jqxhr){
            if(textStatus == "success"){
                this.comp=AdobeAn.getComposition("ABA0D253ED9D3B4B9E7034933F402D9C");
                var lib = this.comp.getLibrary();
                this.exportRoot = new lib.ani_nick();
    ...
    Nick.prototype = {
        ...
        handleClick : function(e){
            console.log("Nick_click : type = " + this.name);
            $(window).trigger({type:"nick_click",character:this,name:"nick"});
        },
