(function(exports){
    function Activity3Script(){

    }
    Activity3Script.prototype = {
        initialize : function(){
        ...
        onPlayVideo : function(){
            ...
            "set"+controller.model.quizSetNum+"/mov";
            controller.videoManager.init(this.videoContain,url,true,$.proxy(this.setCharater,this),controller.model.act3FirstView); //경로.
            controller.model.act3FirstView = true;
        },
        ...
        setCharater : function(){
            ...
            url = controller.model.soundPath + controller.model.activeAct+"/character/view2/go";
        ...
        onNextView : function(){
            controller.dataManager.loadLog("end",{"quizNum":controller.model.quizSetNum,"yes_cnt":"1","fail_cnt":"1","yes_yn":"Y"},function(){
                controller.characterManager.resetAni();
                $("#gameContainer").html("");
                controller.onloadAct3("game");
            },this);
        }
    };
    exports.Activity3Script = Activity3Script;
})(this);