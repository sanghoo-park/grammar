...
controller.model.isPart = "2";
var randomArray = new RandomArray();
var textColorAni = new TextColorAni();
var testModule;
var developerTrace;
var speed = 15;
...
function loadTitle(){
    ...
    new ButtonUtil().init("start_button","./asset/img/","startBtn2");
...
function loadIntro(){
    $("#gameContainer").hide();
    $("#progress").hide();
    controller.videoManager.init($("#top_vod"),controller.model.videoPath+"/intro/part2_intro",false,loadHomeAni);
    setTimeout(function(){
...
function loadHomeAni(){
    console.log("click");
    controller.videoManager.init($("#top_vod"),controller.model.videoPath+"/home/home2",false,end);
    $("#top_vod video").on("click",function(e){
        console.log("click");
        end();
    });
